...
<h1 className="app-page-title">Settings</h1>
  ...
  <circle cx="8" cy="4.5" r="1"></circle>
									    ...
									    <input type="text" className="form-control" id="setting-input-1" defaultValue="Lorem Ipsum Ltd." required=""/>
									</div>
									<div className="mb-3">
									    <label htmlFor="setting-input-2" className="form-label">Contact Name</label>
									    <input type="text" className="form-control" id="setting-input-2" defaultValue="Steve Doe" required=""/>
									</div>
								    <div className="mb-3">
									    <label htmlFor="setting-input-3" className="form-label">Business Email Address</label>
									    <input type="email" className="form-control" id="setting-input-3" defaultValue="hello@companywebsite.com"/>
									</div>
						    ...
						    <div className="app-card-body">
							    <form className="settings-form">
								    <div className="form-check mb-3">
										<input className="form-check-input" type="checkbox" value="" id="settings-checkbox-1" defaultChecked=""/>
										<label className="form-check-label" htmlFor="settings-checkbox-1">
										    Keep user app activity history
										</label>
									</div>
									<div className="form-check mb-3">
									    <input className="form-check-input" type="checkbox" value="" id="settings-checkbox-2" defaultChecked=""/>
										<label className="form-check-label" htmlFor="settings-checkbox-2">
										    Keep user app preferences
										</label>
									</div>
									<div className="form-check mb-3">
									    <input className="form-check-input" type="checkbox" value="" id="settings-checkbox-3"/>
										<label className="form-check-label" htmlFor="settings-checkbox-3">
										    Keep user app search history
										</label>
									</div>
									<div className="form-check mb-3">
									    <input className="form-check-input" type="checkbox" value="" id="settings-checkbox-4"/>
										<label className="form-check-label" htmlFor="settings-checkbox-4">
										    Lorem ipsum dolor sit amet
										</label>
									</div>
									<div className="form-check mb-3">
									    <input className="form-check-input" type="checkbox" value="" id="settings-checkbox-5"/>
										<label className="form-check-label" htmlFor="settings-checkbox-5">
						    ...
						    <div className="app-card-body">
							    <form className="settings-form">
								    <div className="form-check form-switch mb-3">
										<input className="form-check-input" type="checkbox" id="settings-switch-1" defaultChecked=""/>
										<label className="form-check-label" htmlFor="settings-switch-1">Project notifications</label>
									</div>
									<div className="form-check form-switch mb-3">
										<input className="form-check-input" type="checkbox" id="settings-switch-2"/>
										<label className="form-check-label" htmlFor="settings-switch-2">Web browser push notifications</label>
									</div>
									<div className="form-check form-switch mb-3">
										<input className="form-check-input" type="checkbox" id="settings-switch-3" defaultChecked=""/>
										<label className="form-check-label" htmlFor="settings-switch-3">Mobile push notifications</label>
									</div>
									<div className="form-check form-switch mb-3">
										<input className="form-check-input" type="checkbox" id="settings-switch-4"/>
										<label className="form-check-label" htmlFor="settings-switch-4">Lorem ipsum notifications</label>
									</div>
									<div className="form-check form-switch mb-3">
										<input className="form-check-input" type="checkbox" id="settings-switch-5"/>
										<label className="form-check-label" htmlFor="settings-switch-5">Lorem ipsum notifications</label>
									</div>
									<div className="mt-3">
									    <button type="submit" className="btn app-btn-primary">Save Changes</button>
									</div>
