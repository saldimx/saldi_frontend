	...
	if(id==='test'){
		return (
			...
			<ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
				<li className="ms-3"><a className="text-muted" href="https://www.instagram.com/saldi.mx/"><svg className="bi" width="24" height="24">{insta}</svg></a></li>
				<li className="ms-3"><a className="text-muted" href="https://www.facebook.com/www.saldi.mx"><svg className="bi" width="24" height="24">{fb}</svg></a></li>
				<li className="ms-3"><a className="text-muted" href="https://www.linkedin.com/company/saldi-mx/"><svg className="bi" width="24" height="24">{link}</svg></a></li>
			</ul>
			</footer>
		</div>
			</>
